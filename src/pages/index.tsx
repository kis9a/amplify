...
const Todo = () => {
  ...
  const onCreateTodo = async () => {
    const data: CreateTodoInput = { name: newTodoNameInput }
    ...
    return (
      <div className="todo-container">
        <div className="input-section flex items-center w-11/12">
          <input
            autoFocus
            className="shadow appearance-none border rounded w-full py-2 pl-3 pr-12 text-gray-800 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div className="input-button-section flex w-11/12 mr-20 justify-end">
          <div className="input-section-detail">
            <div
              onClick={() => setIsOpenDescriptionInput(!isOpenDescriptionInput)}
              className="flex  w-1/12  justify-center  min-h-4 min-w-12 my-2 bg-gray-200 text-black py-1 px-4  rounded shadow"
            >
              <div>
          ...
          <button
            className="flex  w-1/12  justify-center  min-h-4 min-w-12 my-2 bg-yellow-400 text-black py-1 px-2  rounded shadow"
        ...
        {isOpenDescriptionInput && (
          <div className="detail-input-section flex items-center w-11/12">
            <textarea
